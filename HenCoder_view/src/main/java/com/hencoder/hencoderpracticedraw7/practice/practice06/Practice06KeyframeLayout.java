    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Keyframe keyframe2 = Keyframe.ofFloat(0.2f,10);
                Keyframe keyframe3 = Keyframe.ofFloat(0.4f,50);
                Keyframe keyframe4 = Keyframe.ofFloat(0.6f,80);
                Keyframe keyframe5 = Keyframe.ofFloat(0.8f,100);
                Keyframe keyframe6 = Keyframe.ofFloat(0.9f,80);
                Keyframe keyframe7 = Keyframe.ofFloat(1,50);

                PropertyValuesHolder propertyValuesHolder = PropertyValuesHolder.ofKeyframe("progress",keyframe1,
                        keyframe2,keyframe3,keyframe4,keyframe5,keyframe6,keyframe7);
