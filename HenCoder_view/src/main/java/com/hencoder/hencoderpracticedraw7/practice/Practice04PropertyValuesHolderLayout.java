    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PropertyValuesHolder propertyValuesHolder1 = PropertyValuesHolder.ofFloat("scaleX",1,1.5f);
                PropertyValuesHolder propertyValuesHolder2 = PropertyValuesHolder.ofFloat("scaleY",1,2);
                PropertyValuesHolder propertyValuesHolder3 = PropertyValuesHolder.ofFloat("alpha",1,0.5f);

                ObjectAnimator.ofPropertyValuesHolder(view,propertyValuesHolder1,
                        propertyValuesHolder2,propertyValuesHolder3).setDuration(2000).start();
            }
        });
    }
}
